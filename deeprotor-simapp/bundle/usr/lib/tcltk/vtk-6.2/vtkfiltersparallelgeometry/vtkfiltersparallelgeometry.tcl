...
if {[info commands ::vtk::init::require_package] != ""} {
  if {[::vtk::init::require_package vtkFiltersParallelGeometryTCL 6.2]} {
    package provide vtkfiltersparallelgeometry 6.2
  }
} else {
 ...
 to point to the VTK build tree."
  if {[info commands vtkObject] != "" ||
    [::vtk::load_component vtkFiltersParallelGeometryTCL] == ""} {
    package provide vtkfiltersparallelgeometry 6.2
  }
}

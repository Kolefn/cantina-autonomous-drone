...
if {[info commands ::vtk::init::require_package] != ""} {
  if {[::vtk::init::require_package vtkRenderingFreeTypeOpenGLTCL 6.2]} {
    package provide vtkrenderingfreetypeopengl 6.2
  }
} else {
 ...
 to point to the VTK build tree."
  if {[info commands vtkObject] != "" ||
    [::vtk::load_component vtkRenderingFreeTypeOpenGLTCL] == ""} {
    package provide vtkrenderingfreetypeopengl 6.2
  }
}

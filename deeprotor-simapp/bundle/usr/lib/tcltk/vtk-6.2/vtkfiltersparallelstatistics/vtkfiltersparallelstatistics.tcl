...
if {[info commands ::vtk::init::require_package] != ""} {
  if {[::vtk::init::require_package vtkFiltersParallelStatisticsTCL 6.2]} {
    package provide vtkfiltersparallelstatistics 6.2
  }
} else {
 ...
 to point to the VTK build tree."
  if {[info commands vtkObject] != "" ||
    [::vtk::load_component vtkFiltersParallelStatisticsTCL] == ""} {
    package provide vtkfiltersparallelstatistics 6.2
  }
}

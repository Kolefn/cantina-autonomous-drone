...
if {[info commands ::vtk::init::require_package] != ""} {
  if {[::vtk::init::require_package vtkFiltersParallelFlowPathsTCL 6.2]} {
    package provide vtkfiltersparallelflowpaths 6.2
  }
} else {
 ...
 to point to the VTK build tree."
  if {[info commands vtkObject] != "" ||
    [::vtk::load_component vtkFiltersParallelFlowPathsTCL] == ""} {
    package provide vtkfiltersparallelflowpaths 6.2
  }
}

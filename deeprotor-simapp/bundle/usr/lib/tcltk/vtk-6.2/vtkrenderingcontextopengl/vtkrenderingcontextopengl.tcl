...
if {[info commands ::vtk::init::require_package] != ""} {
  if {[::vtk::init::require_package vtkRenderingContextOpenGLTCL 6.2]} {
    package provide vtkrenderingcontextopengl 6.2
  }
} else {
 ...
 to point to the VTK build tree."
  if {[info commands vtkObject] != "" ||
    [::vtk::load_component vtkRenderingContextOpenGLTCL] == ""} {
    package provide vtkrenderingcontextopengl 6.2
  }
}

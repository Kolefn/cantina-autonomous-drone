...
if {[info commands ::vtk::init::require_package] != ""} {
  if {[::vtk::init::require_package vtkCommonComputationalGeometryTCL 6.2]} {
    package provide vtkcommoncomputationalgeometry 6.2
  }
} else {
 ...
 to point to the VTK build tree."
  if {[info commands vtkObject] != "" ||
    [::vtk::load_component vtkCommonComputationalGeometryTCL] == ""} {
    package provide vtkcommoncomputationalgeometry 6.2
  }
}

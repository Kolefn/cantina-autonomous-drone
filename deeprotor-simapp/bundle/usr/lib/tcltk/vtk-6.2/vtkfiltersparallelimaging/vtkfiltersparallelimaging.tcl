...
if {[info commands ::vtk::init::require_package] != ""} {
  if {[::vtk::init::require_package vtkFiltersParallelImagingTCL 6.2]} {
    package provide vtkfiltersparallelimaging 6.2
  }
} else {
 ...
 to point to the VTK build tree."
  if {[info commands vtkObject] != "" ||
    [::vtk::load_component vtkFiltersParallelImagingTCL] == ""} {
    package provide vtkfiltersparallelimaging 6.2
  }
}

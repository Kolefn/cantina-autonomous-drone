...
if {[info commands ::vtk::init::require_package] != ""} {
  if {[::vtk::init::require_package vtkInfovisBoostGraphAlgorithmsTCL 6.2]} {
    package provide vtkinfovisboostgraphalgorithms 6.2
  }
} else {
 ...
 to point to the VTK build tree."
  if {[info commands vtkObject] != "" ||
    [::vtk::load_component vtkInfovisBoostGraphAlgorithmsTCL] == ""} {
    package provide vtkinfovisboostgraphalgorithms 6.2
  }
}

...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5QuickTest" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickTest_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_QuickTest_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5QuickTest_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(_Qt5QuickTest_OWN_INCLUDE_DIRS "${_qt5QuickTest_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5QuickTest_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickTest")
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickTest/5.5.1"
        "${_qt5QuickTest_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickTest/5.5.1/QtQuickTest"
    )
    ...
    macro(_populate_QuickTest_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5QuickTest_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickTest_check_file_exists(${imported_location})

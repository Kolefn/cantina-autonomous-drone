...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Test" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Test_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Test_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Test_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Test)
    ...
    set(_Qt5Test_OWN_INCLUDE_DIRS "${_qt5Test_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Test_install_prefix}/include/x86_64-linux-gnu/qt5/QtTest")
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/x86_64-linux-gnu/qt5/QtTest/5.5.1"
        "${_qt5Test_install_prefix}/include/x86_64-linux-gnu/qt5/QtTest/5.5.1/QtTest"
    )
    ...
    macro(_populate_Test_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Test_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Test_check_file_exists(${imported_location})

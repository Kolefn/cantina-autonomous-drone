...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5XmlPatterns" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5XmlPatterns_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_XmlPatterns_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5XmlPatterns_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    set(_Qt5XmlPatterns_OWN_INCLUDE_DIRS "${_qt5XmlPatterns_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5XmlPatterns_install_prefix}/include/x86_64-linux-gnu/qt5/QtXmlPatterns")
    set(Qt5XmlPatterns_PRIVATE_INCLUDE_DIRS
        "${_qt5XmlPatterns_install_prefix}/include/x86_64-linux-gnu/qt5/QtXmlPatterns/5.5.1"
        "${_qt5XmlPatterns_install_prefix}/include/x86_64-linux-gnu/qt5/QtXmlPatterns/5.5.1/QtXmlPatterns"
    )
    ...
    macro(_populate_XmlPatterns_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5XmlPatterns_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_XmlPatterns_check_file_exists(${imported_location})

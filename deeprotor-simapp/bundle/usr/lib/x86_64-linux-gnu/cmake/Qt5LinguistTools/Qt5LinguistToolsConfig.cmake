...
if (NOT TARGET Qt5::lrelease)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/lib/x86_64-linux-gnu/qt5/bin/lrelease")
...
if (NOT TARGET Qt5::lupdate)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/lib/x86_64-linux-gnu/qt5/bin/lupdate")
    _qt5_LinguistTools_check_file_exists(${imported_location})
...
if (NOT TARGET Qt5::lconvert)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/lib/x86_64-linux-gnu/qt5/bin/lconvert")
    _qt5_LinguistTools_check_file_exists(${imported_location})

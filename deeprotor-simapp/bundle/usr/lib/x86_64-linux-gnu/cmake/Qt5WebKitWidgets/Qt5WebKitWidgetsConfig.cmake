...
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WebKitWidgets_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_WebKitWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5WebKitWidgets_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::WebKitWidgets)
    ...
    set(_Qt5WebKitWidgets_OWN_INCLUDE_DIRS "${_qt5WebKitWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5WebKitWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtWebKitWidgets")
    set(Qt5WebKitWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebKitWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtWebKitWidgets/5.5.1"
        "${_qt5WebKitWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtWebKitWidgets/5.5.1/QtWebKitWidgets"
    )
    ...
    macro(_populate_WebKitWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebKitWidgets_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebKitWidgets_check_file_exists(${imported_location})

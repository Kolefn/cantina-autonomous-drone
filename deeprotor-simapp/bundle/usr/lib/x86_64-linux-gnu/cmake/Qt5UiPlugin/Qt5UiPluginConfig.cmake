...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5UiPlugin" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5UiPlugin_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::UiPlugin)
    ...
    set(_Qt5UiPlugin_OWN_INCLUDE_DIRS "${_qt5UiPlugin_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5UiPlugin_install_prefix}/include/x86_64-linux-gnu/qt5/QtUiPlugin")
    ...
    macro(_populate_UiPlugin_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5UiPlugin_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")

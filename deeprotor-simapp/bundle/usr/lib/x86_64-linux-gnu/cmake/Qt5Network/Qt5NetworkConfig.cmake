...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Network" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Network_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Network_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Network_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Network)
    ...
    set(_Qt5Network_OWN_INCLUDE_DIRS "${_qt5Network_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Network_install_prefix}/include/x86_64-linux-gnu/qt5/QtNetwork")
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/x86_64-linux-gnu/qt5/QtNetwork/5.5.1"
        "${_qt5Network_install_prefix}/include/x86_64-linux-gnu/qt5/QtNetwork/5.5.1/QtNetwork"
    )
    ...
    macro(_populate_Network_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Network_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Network_check_file_exists(${imported_location})

...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Xml" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Xml_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Xml_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Xml_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Xml)
    ...
    set(_Qt5Xml_OWN_INCLUDE_DIRS "${_qt5Xml_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Xml_install_prefix}/include/x86_64-linux-gnu/qt5/QtXml")
    set(Qt5Xml_PRIVATE_INCLUDE_DIRS
        "${_qt5Xml_install_prefix}/include/x86_64-linux-gnu/qt5/QtXml/5.5.1"
        "${_qt5Xml_install_prefix}/include/x86_64-linux-gnu/qt5/QtXml/5.5.1/QtXml"
    )
    ...
    macro(_populate_Xml_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Xml_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Xml_check_file_exists(${imported_location})

...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Help" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Help_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Help_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Help_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Help)
    ...
    set(_Qt5Help_OWN_INCLUDE_DIRS "${_qt5Help_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Help_install_prefix}/include/x86_64-linux-gnu/qt5/QtHelp")
    set(Qt5Help_PRIVATE_INCLUDE_DIRS
        "${_qt5Help_install_prefix}/include/x86_64-linux-gnu/qt5/QtHelp/5.5.1"
        "${_qt5Help_install_prefix}/include/x86_64-linux-gnu/qt5/QtHelp/5.5.1/QtHelp"
    )
    ...
    macro(_populate_Help_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Help_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Help_check_file_exists(${imported_location})

...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Qml" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Qml_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Qml_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Qml_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Qml)
    ...
    set(_Qt5Qml_OWN_INCLUDE_DIRS "${_qt5Qml_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Qml_install_prefix}/include/x86_64-linux-gnu/qt5/QtQml")
    set(Qt5Qml_PRIVATE_INCLUDE_DIRS
        "${_qt5Qml_install_prefix}/include/x86_64-linux-gnu/qt5/QtQml/5.5.1"
        "${_qt5Qml_install_prefix}/include/x86_64-linux-gnu/qt5/QtQml/5.5.1/QtQml"
    )
    ...
    macro(_populate_Qml_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Qml_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Qml_check_file_exists(${imported_location})

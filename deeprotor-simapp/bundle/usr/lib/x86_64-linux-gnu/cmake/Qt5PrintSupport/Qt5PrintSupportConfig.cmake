...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5PrintSupport" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5PrintSupport_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_PrintSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5PrintSupport_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::PrintSupport)
    ...
    set(_Qt5PrintSupport_OWN_INCLUDE_DIRS "${_qt5PrintSupport_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5PrintSupport_install_prefix}/include/x86_64-linux-gnu/qt5/QtPrintSupport")
    set(Qt5PrintSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PrintSupport_install_prefix}/include/x86_64-linux-gnu/qt5/QtPrintSupport/5.5.1"
        "${_qt5PrintSupport_install_prefix}/include/x86_64-linux-gnu/qt5/QtPrintSupport/5.5.1/QtPrintSupport"
    )
    ...
    macro(_populate_PrintSupport_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5PrintSupport_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_PrintSupport_check_file_exists(${imported_location})

...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5MultimediaWidgets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5MultimediaWidgets_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_MultimediaWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5MultimediaWidgets_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    set(_Qt5MultimediaWidgets_OWN_INCLUDE_DIRS "${_qt5MultimediaWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5MultimediaWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtMultimediaWidgets")
    set(Qt5MultimediaWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtMultimediaWidgets/5.5.1"
        "${_qt5MultimediaWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtMultimediaWidgets/5.5.1/QtMultimediaWidgets"
    )
    ...
    macro(_populate_MultimediaWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5MultimediaWidgets_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_MultimediaWidgets_check_file_exists(${imported_location})

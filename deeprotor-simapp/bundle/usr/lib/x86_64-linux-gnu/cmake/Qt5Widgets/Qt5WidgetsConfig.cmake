...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Widgets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Widgets_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Widgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Widgets_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Widgets)
    ...
    set(_Qt5Widgets_OWN_INCLUDE_DIRS "${_qt5Widgets_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Widgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtWidgets")
    set(Qt5Widgets_PRIVATE_INCLUDE_DIRS
        "${_qt5Widgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtWidgets/5.5.1"
        "${_qt5Widgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtWidgets/5.5.1/QtWidgets"
    )
    ...
    macro(_populate_Widgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Widgets_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Widgets_check_file_exists(${imported_location})

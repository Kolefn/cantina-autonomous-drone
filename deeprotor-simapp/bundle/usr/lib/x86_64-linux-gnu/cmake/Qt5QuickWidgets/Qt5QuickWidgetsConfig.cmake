...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5QuickWidgets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickWidgets_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_QuickWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5QuickWidgets_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(_Qt5QuickWidgets_OWN_INCLUDE_DIRS "${_qt5QuickWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5QuickWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickWidgets")
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickWidgets/5.5.1"
        "${_qt5QuickWidgets_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickWidgets/5.5.1/QtQuickWidgets"
    )
    ...
    macro(_populate_QuickWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5QuickWidgets_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickWidgets_check_file_exists(${imported_location})

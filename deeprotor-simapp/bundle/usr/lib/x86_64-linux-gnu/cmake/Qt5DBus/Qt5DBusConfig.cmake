...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5DBus" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5DBus_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_DBus_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5DBus_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::DBus)
    ...
    set(_Qt5DBus_OWN_INCLUDE_DIRS "${_qt5DBus_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5DBus_install_prefix}/include/x86_64-linux-gnu/qt5/QtDBus")
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/x86_64-linux-gnu/qt5/QtDBus/5.5.1"
        "${_qt5DBus_install_prefix}/include/x86_64-linux-gnu/qt5/QtDBus/5.5.1/QtDBus"
    )
    ...
    macro(_populate_DBus_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5DBus_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_DBus_check_file_exists(${imported_location})

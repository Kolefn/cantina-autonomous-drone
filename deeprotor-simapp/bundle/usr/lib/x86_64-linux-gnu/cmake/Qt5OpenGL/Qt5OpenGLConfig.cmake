...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5OpenGL" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5OpenGL_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_OpenGL_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5OpenGL_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(_Qt5OpenGL_OWN_INCLUDE_DIRS "${_qt5OpenGL_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5OpenGL_install_prefix}/include/x86_64-linux-gnu/qt5/QtOpenGL")
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/x86_64-linux-gnu/qt5/QtOpenGL/5.5.1"
        "${_qt5OpenGL_install_prefix}/include/x86_64-linux-gnu/qt5/QtOpenGL/5.5.1/QtOpenGL"
    )
    ...
    macro(_populate_OpenGL_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5OpenGL_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_OpenGL_check_file_exists(${imported_location})

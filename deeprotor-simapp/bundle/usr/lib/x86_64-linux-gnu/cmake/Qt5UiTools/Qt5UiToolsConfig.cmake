...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5UiTools" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5UiTools_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_UiTools_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5UiTools_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::UiTools)
    ...
    set(_Qt5UiTools_OWN_INCLUDE_DIRS "${_qt5UiTools_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5UiTools_install_prefix}/include/x86_64-linux-gnu/qt5/QtUiTools")
    set(Qt5UiTools_PRIVATE_INCLUDE_DIRS
        "${_qt5UiTools_install_prefix}/include/x86_64-linux-gnu/qt5/QtUiTools/5.5.1"
        "${_qt5UiTools_install_prefix}/include/x86_64-linux-gnu/qt5/QtUiTools/5.5.1/QtUiTools"
    )
    ...
    macro(_populate_UiTools_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5UiTools_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_UiTools_check_file_exists(${imported_location})

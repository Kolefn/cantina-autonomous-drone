...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Svg" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Svg_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Svg_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Svg_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Svg)
    ...
    set(_Qt5Svg_OWN_INCLUDE_DIRS "${_qt5Svg_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Svg_install_prefix}/include/x86_64-linux-gnu/qt5/QtSvg")
    set(Qt5Svg_PRIVATE_INCLUDE_DIRS
        "${_qt5Svg_install_prefix}/include/x86_64-linux-gnu/qt5/QtSvg/5.5.1"
        "${_qt5Svg_install_prefix}/include/x86_64-linux-gnu/qt5/QtSvg/5.5.1/QtSvg"
    )
    ...
    macro(_populate_Svg_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Svg_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Svg_check_file_exists(${imported_location})

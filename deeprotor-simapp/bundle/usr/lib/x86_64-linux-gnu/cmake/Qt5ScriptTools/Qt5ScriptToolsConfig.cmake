...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5ScriptTools" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5ScriptTools_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_ScriptTools_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5ScriptTools_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::ScriptTools)
    ...
    set(_Qt5ScriptTools_OWN_INCLUDE_DIRS "${_qt5ScriptTools_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5ScriptTools_install_prefix}/include/x86_64-linux-gnu/qt5/QtScriptTools")
    set(Qt5ScriptTools_PRIVATE_INCLUDE_DIRS
        "${_qt5ScriptTools_install_prefix}/include/x86_64-linux-gnu/qt5/QtScriptTools/5.5.1"
        "${_qt5ScriptTools_install_prefix}/include/x86_64-linux-gnu/qt5/QtScriptTools/5.5.1/QtScriptTools"
    )
    ...
    macro(_populate_ScriptTools_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5ScriptTools_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_ScriptTools_check_file_exists(${imported_location})

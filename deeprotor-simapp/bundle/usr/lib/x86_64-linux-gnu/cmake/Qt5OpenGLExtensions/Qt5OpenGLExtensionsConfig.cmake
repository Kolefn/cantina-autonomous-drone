...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5OpenGLExtensions" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5OpenGLExtensions_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_OpenGLExtensions_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5OpenGLExtensions_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    set(_Qt5OpenGLExtensions_OWN_INCLUDE_DIRS "${_qt5OpenGLExtensions_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5OpenGLExtensions_install_prefix}/include/x86_64-linux-gnu/qt5/QtOpenGLExtensions")
    ...
    macro(_populate_OpenGLExtensions_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5OpenGLExtensions_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_OpenGLExtensions_check_file_exists(${imported_location})

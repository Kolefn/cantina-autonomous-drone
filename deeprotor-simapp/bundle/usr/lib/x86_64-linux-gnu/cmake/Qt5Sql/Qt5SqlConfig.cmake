...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Sql" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Sql_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Sql_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Sql_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Sql)
    ...
    set(_Qt5Sql_OWN_INCLUDE_DIRS "${_qt5Sql_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Sql_install_prefix}/include/x86_64-linux-gnu/qt5/QtSql")
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/include/x86_64-linux-gnu/qt5/QtSql/5.5.1"
        "${_qt5Sql_install_prefix}/include/x86_64-linux-gnu/qt5/QtSql/5.5.1/QtSql"
    )
    ...
    macro(_populate_Sql_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Sql_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Sql_check_file_exists(${imported_location})

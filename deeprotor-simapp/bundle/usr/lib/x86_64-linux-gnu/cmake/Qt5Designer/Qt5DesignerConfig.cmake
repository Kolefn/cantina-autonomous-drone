...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Designer" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Designer_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Designer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Designer_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Designer)
    ...
    set(_Qt5Designer_OWN_INCLUDE_DIRS "${_qt5Designer_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Designer_install_prefix}/include/x86_64-linux-gnu/qt5/QtDesigner")
    set(Qt5Designer_PRIVATE_INCLUDE_DIRS
        "${_qt5Designer_install_prefix}/include/x86_64-linux-gnu/qt5/QtDesigner/5.5.1"
        "${_qt5Designer_install_prefix}/include/x86_64-linux-gnu/qt5/QtDesigner/5.5.1/QtDesigner"
    )
    ...
    macro(_populate_Designer_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Designer_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Designer_check_file_exists(${imported_location})

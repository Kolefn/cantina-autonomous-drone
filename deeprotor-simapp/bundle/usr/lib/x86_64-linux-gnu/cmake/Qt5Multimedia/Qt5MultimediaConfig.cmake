...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Multimedia" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Multimedia_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Multimedia_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Multimedia_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(_Qt5Multimedia_OWN_INCLUDE_DIRS "${_qt5Multimedia_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Multimedia_install_prefix}/include/x86_64-linux-gnu/qt5/QtMultimedia")
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/include/x86_64-linux-gnu/qt5/QtMultimedia/5.5.1"
        "${_qt5Multimedia_install_prefix}/include/x86_64-linux-gnu/qt5/QtMultimedia/5.5.1/QtMultimedia"
    )
    ...
    macro(_populate_Multimedia_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Multimedia_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Multimedia_check_file_exists(${imported_location})

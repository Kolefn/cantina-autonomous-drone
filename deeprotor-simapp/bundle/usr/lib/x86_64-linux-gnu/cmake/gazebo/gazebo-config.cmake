...
find_library(gazebo_proto_msgs_lib gazebo_msgs
  PATHS "/usr/lib/x86_64-linux-gnu" NO_DEFAULT_PATH)
...
list(APPEND GAZEBO_INCLUDE_DIRS /usr/include)
list(APPEND GAZEBO_INCLUDE_DIRS /usr/include/gazebo-7)

list(APPEND GAZEBO_LIBRARY_DIRS /usr/lib/x86_64-linux-gnu)
list(APPEND GAZEBO_LIBRARY_DIRS /usr/lib/x86_64-linux-gnu/gazebo-7/plugins)

list(APPEND GAZEBO_CFLAGS -I/usr/include)
list(APPEND GAZEBO_CFLAGS -I/usr/include/gazebo-7)
...
foreach(dep Boost;Protobuf;SDFormat;OGRE)
  if(NOT ${dep}_FOUND)
    if (${dep} MATCHES "Boost")
      find_package(Boost 1.40.0 REQUIRED thread system filesystem program_options regex iostreams date_time)
    else()
...
list(APPEND GAZEBO_LDFLAGS -Wl,-rpath,/usr/lib/x86_64-linux-gnu/gazebo-7/plugins)
list(APPEND GAZEBO_LDFLAGS -L/usr/lib/x86_64-linux-gnu)
list(APPEND GAZEBO_LDFLAGS -L/usr/lib/x86_64-linux-gnu/gazebo-7/plugins)

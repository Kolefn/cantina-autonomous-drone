...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Quick" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Quick_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Quick_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Quick_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Quick)
    ...
    set(_Qt5Quick_OWN_INCLUDE_DIRS "${_qt5Quick_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Quick_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuick")
    set(Qt5Quick_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuick/5.5.1"
        "${_qt5Quick_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuick/5.5.1/QtQuick"
    )
    ...
    macro(_populate_Quick_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Quick_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Quick_check_file_exists(${imported_location})

...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5WebKit" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WebKit_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_WebKit_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5WebKit_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::WebKit)
    ...
    set(_Qt5WebKit_OWN_INCLUDE_DIRS "${_qt5WebKit_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5WebKit_install_prefix}/include/x86_64-linux-gnu/qt5/QtWebKit")
    set(Qt5WebKit_PRIVATE_INCLUDE_DIRS
        "${_qt5WebKit_install_prefix}/include/x86_64-linux-gnu/qt5/QtWebKit/5.5.1"
        "${_qt5WebKit_install_prefix}/include/x86_64-linux-gnu/qt5/QtWebKit/5.5.1/QtWebKit"
    )
    ...
    macro(_populate_WebKit_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebKit_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebKit_check_file_exists(${imported_location})

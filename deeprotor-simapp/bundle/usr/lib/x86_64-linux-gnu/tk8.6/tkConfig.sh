...
TK_LIBS='-lX11 -lXss -lXext -lXft -lfontconfig -lfreetype -lfontconfig  -lpthread -ldl -lz  -lpthread -lieee -lm'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/lib/x86_64-linux-gnu -ltk8.6'
...
TK_INCLUDE_SPEC='-I/usr/include/tcl8.6'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/lib/x86_64-linux-gnu -ltkstub8.6'
...
TK_BUILD_STUB_LIB_PATH='/usr/lib/x86_64-linux-gnu/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/usr/lib/x86_64-linux-gnu/libtkstub8.6.a'

...
_pkg_config = {
    ...
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/usr/include/python3.5m',
    'py_inc_dir':         '/usr/include/python3.5m',
    'py_lib_dir':         '/usr/lib/python3.5/config',
    'py_version':         0x030501,
    'qt_framework':       0,
    'sip_bin':            '/usr/bin/sip',
    'sip_config_args':    '-d /usr/lib/python3.5/dist-packages -u STRIP= CFLAGS= -g -O2 -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2 CFLAGS_RELEASE= CXXFLAGS= -g -O2 -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2 CXXFLAGS_RELEASE= LFLAGS= -Wl,-Bsymbolic-functions -Wl,-z,relro LFLAGS_RELEASE=',
    'sip_inc_dir':        '/usr/include/python3.5m',
    'sip_mod_dir':        '/usr/lib/python3.5/dist-packages',

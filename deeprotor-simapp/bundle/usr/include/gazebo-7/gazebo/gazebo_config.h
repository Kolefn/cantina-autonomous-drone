...
#define GAZEBO_MINOR_VERSION 16
#define GAZEBO_PATCH_VERSION 0

#define GAZEBO_VERSION "7.16"
#define GAZEBO_VERSION_FULL "7.16.0"

#define GAZEBO_VERSION_HEADER "Gazebo multi-robot simulator, version 7.16.0\nCopyright (C) 2012 Open Source Robotics Foundation.\nReleased under the Apache 2 License.\nhttp://gazebosim.org\n\n"

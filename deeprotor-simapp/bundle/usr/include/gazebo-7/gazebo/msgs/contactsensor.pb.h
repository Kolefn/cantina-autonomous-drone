...
inline void ContactSensor::clear_collision_name() {
  if (collision_name_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
...
inline ::std::string* ContactSensor::release_collision_name() {
  ...
  if (collision_name_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    collision_name_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}

...
inline void Contact::clear_collision1() {
  if (collision1_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    collision1_->clear();
  }
...
inline ::std::string* Contact::release_collision1() {
  ...
  if (collision1_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    collision1_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
...
inline void Contact::clear_collision2() {
  if (collision2_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    collision2_->clear();
  }
...
inline ::std::string* Contact::release_collision2() {
  ...
  if (collision2_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    collision2_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}

...
inline void CameraCmd::clear_follow_model() {
  if (follow_model_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    follow_model_->clear();
  }
...
inline ::std::string* CameraCmd::release_follow_model() {
  ...
  if (follow_model_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    follow_model_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}

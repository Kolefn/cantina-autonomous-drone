...
inline void Material::clear_normal_map() {
  if (normal_map_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    normal_map_->clear();
  }
...
inline ::std::string* Material::release_normal_map() {
  ...
  if (normal_map_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    normal_map_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
...
template <> struct is_proto_enum< ::gazebo::msgs::Material_ShaderType> : ::google::protobuf::internal::true_type {};
template <>

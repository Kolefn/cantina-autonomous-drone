...
void GZ_MSGS_VISIBLE protobuf_AddDesc_gz_5fstring_2eproto();
...
class GZ_MSGS_VISIBLE GzString : public ::google::protobuf::Message {
 public:
  GzString();
  virtual ~GzString();
 ...
 private:
  ...
  ::std::string* data_;
  friend void GZ_MSGS_VISIBLE protobuf_AddDesc_gz_5fstring_2eproto();

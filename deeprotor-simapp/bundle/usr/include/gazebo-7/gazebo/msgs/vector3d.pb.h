...
void GZ_MSGS_VISIBLE protobuf_AddDesc_vector3d_2eproto();
...
class GZ_MSGS_VISIBLE Vector3d : public ::google::protobuf::Message {
 public:
  Vector3d();
  virtual ~Vector3d();
 ...
 private:
  ...
  double y_;
  double z_;
  friend void GZ_MSGS_VISIBLE protobuf_AddDesc_vector3d_2eproto();

...
inline void LogStatus_LogFile::clear_full_path() {
  if (full_path_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    full_path_->clear();
  }
  clear_has_full_path();
}
...
inline ::std::string* LogStatus_LogFile::release_full_path() {
  ...
  if (full_path_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    full_path_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
...
template <> struct is_proto_enum< ::gazebo::msgs::LogStatus_LogFile_Units> : ::google::protobuf::internal::true_type {};
template <>

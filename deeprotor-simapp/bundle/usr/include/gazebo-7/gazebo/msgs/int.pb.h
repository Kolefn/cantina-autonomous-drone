...
void GZ_MSGS_VISIBLE protobuf_AddDesc_int_2eproto();
...
class GZ_MSGS_VISIBLE Int : public ::google::protobuf::Message {
 public:
  Int();
  virtual ~Int();
 ...
 private:
  ...
  friend void GZ_MSGS_VISIBLE protobuf_AddDesc_int_2eproto();

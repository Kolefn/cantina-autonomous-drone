...
void GZ_MSGS_VISIBLE protobuf_AddDesc_header_2eproto();
...
class GZ_MSGS_VISIBLE Header : public ::google::protobuf::Message {
 public:
  Header();
  virtual ~Header();
 ...
 private:
  ...
  friend void GZ_MSGS_VISIBLE protobuf_AddDesc_header_2eproto();

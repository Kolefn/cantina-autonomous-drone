...
# Local offset of the front of the drone
RELATIVE_POSITION_OF_FRONT_OF_DRONE = [0.07, 0, 0]
...
# List of required velocity topics, one topic per rotor
VELOCITY_TOPICS = ['/drone/rotor_velocity_controller_1/command',
                   '/drone/rotor_velocity_controller_2/command',
                   '/drone/rotor_velocity_controller_3/command',
                   '/drone/rotor_velocity_controller_4/command']
...
class DeepRotorEnv(gym.Env):
    ...
    def __init__(self):
        ...
        if node_type == SIMULATION_WORKER:
            ...
            # Create the publishers for sending velocity info to the car
    ...
    def infer_reward_state(self, steering_angle, speed):
        ...
        model_location = np.array([
            ...
            model_orientation.apply(RELATIVE_POSITION_OF_FRONT_OF_DRONE)
        ...
        left_rear_wheel_state = self.get_link_state('drone::left_rear_wheel', '')
        left_front_wheel_state = self.get_link_state('drone::left_front_wheel', '')
        right_rear_wheel_state = self.get_link_state('drone::right_rear_wheel', '')
        right_front_wheel_state = self.get_link_state('drone::right_front_wheel', '')
        wheel_points = [

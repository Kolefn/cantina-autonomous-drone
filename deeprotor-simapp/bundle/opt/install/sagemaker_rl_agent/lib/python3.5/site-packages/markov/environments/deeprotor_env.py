...
class DeepRotorEnv(gym.Env):
    ...
    def __init__(self):
        ...
        if node_type == SIMULATION_WORKER:
            ...
            # Create the publishers for sending velocity info to the drone
    ...
    def send_action(self, velocities):
        for i, pub in self.velocity_pub_dict.items():
            pub.publish(velocities[i])
    ...
    def infer_reward_state(self, velocities):
        ...
        if model_crashed:
            ...
            params = {
                ...
                'y': model_y,
                'z': model_z,
                'rotation_z': model_orientation[0],
                'rotation_y': model_orientation[1],
                'rotation_x': model_orientation[2],
                'target_x': target_x,
                'target_y': target_y,
                'target_z': target_z,
                'steps': self.steps,

...
SIMTRACE_CSV_DATA_HEADER = ['episode', 'steps', 'X', 'Y', 'Z', 'yaw', 'pitch', 'roll', 'velocity_rotor_1', 'velocity_rotor_2', 'velocity_rotor_3', 'velocity_rotor_4', 'action', 'reward','crashed', 'target_x', 'target_y', 'target_z', 'tstamp']

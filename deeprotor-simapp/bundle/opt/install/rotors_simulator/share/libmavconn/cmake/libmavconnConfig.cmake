...
if("FALSE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/kole/rotors_simulator_ws/src/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/kole/rotors_simulator_ws/build/src/devel)
  ...
  set(libmavconn_INSTALL_PREFIX /home/kole/rotors_simulator_ws/install/src)
...
if(NOT "include;/usr/include;/opt/ros/kinetic/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kole/rotors_simulator_ws/install/src/${idir}'.  ${_report}")
    endif()

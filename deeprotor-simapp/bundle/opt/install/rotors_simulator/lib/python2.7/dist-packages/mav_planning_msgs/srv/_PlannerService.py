...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.polynomial_plan.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.polynomial_plan_4D.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.sampled_plan.header.frame_id = str[start:end].decode('utf-8')
      else:

...
if("FALSE" STREQUAL "TRUE")
  set(velocity_controllers_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-velocity-controllers-0.13.5)
  set(velocity_controllers_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-velocity-controllers-0.13.5/obj-x86_64-linux-gnu/devel)
  ...
  set(velocity_controllers_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velocity_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()

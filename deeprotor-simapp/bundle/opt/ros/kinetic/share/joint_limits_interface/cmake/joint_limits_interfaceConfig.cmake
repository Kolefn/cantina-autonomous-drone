...
if("FALSE" STREQUAL "TRUE")
  set(joint_limits_interface_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-joint-limits-interface-0.13.3)
  set(joint_limits_interface_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-joint-limits-interface-0.13.3/obj-x86_64-linux-gnu/devel)
  ...
  set(joint_limits_interface_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joint_limits_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()

...
if("FALSE" STREQUAL "TRUE")
  set(hardware_interface_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-hardware-interface-0.13.3)
  set(hardware_interface_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-hardware-interface-0.13.3/obj-x86_64-linux-gnu/devel)
  ...
  set(hardware_interface_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hardware_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()

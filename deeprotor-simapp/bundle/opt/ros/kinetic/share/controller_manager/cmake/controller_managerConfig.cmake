...
if("FALSE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-controller-manager-0.13.3)
  set(controller_manager_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-controller-manager-0.13.3/obj-x86_64-linux-gnu/devel)
  ...
  set(controller_manager_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()

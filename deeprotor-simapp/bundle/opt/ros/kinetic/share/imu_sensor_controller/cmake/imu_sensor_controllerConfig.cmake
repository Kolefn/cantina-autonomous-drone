...
if("FALSE" STREQUAL "TRUE")
  set(imu_sensor_controller_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-imu-sensor-controller-0.13.5)
  set(imu_sensor_controller_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-imu-sensor-controller-0.13.5/obj-x86_64-linux-gnu/devel)
  ...
  set(imu_sensor_controller_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_sensor_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()

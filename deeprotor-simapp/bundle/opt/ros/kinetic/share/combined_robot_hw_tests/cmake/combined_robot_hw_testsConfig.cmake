...
if("FALSE" STREQUAL "TRUE")
  set(combined_robot_hw_tests_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-combined-robot-hw-tests-0.13.3)
  set(combined_robot_hw_tests_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-combined-robot-hw-tests-0.13.3/obj-x86_64-linux-gnu/devel)
  ...
  set(combined_robot_hw_tests_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'combined_robot_hw_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()

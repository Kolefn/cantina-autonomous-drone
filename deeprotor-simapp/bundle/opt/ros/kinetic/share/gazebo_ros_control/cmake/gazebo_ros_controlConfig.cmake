...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_ros_control_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-gazebo-ros-control-2.5.19)
  set(gazebo_ros_control_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-gazebo-ros-control-2.5.19/obj-x86_64-linux-gnu/devel)
  ...
  set(gazebo_ros_control_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
